...
# 
# if (length(args)==0) {
#   stop("Usage: script.R <method.name [GC,CCM]> <z [1:5]>", call.=FALSE)
# }
# 
...
z_score_MON <- readRDS(paste0(z.dir, "GWL-Tabriz-WFFT_", method.name, "_Layer-", layer.name, "_ZSCORE-Surr", cnt.surr, "_FOR.RDS"))
...
#Save results
saveRDS(z_score, paste0(z.dir, "GWL-Tabriz-WFFT_", method.name, "_Layer-", layer.name, "_ZSCORE-Surr", cnt.surr, "_Z", z, "_MUX.RDS"))
